...
| **CONNECT_SOLANA_WALLET**    | Подключение Solana кошелька из solana_wallets.json к боту PAWS (по умолчанию - False) |
| **DISCONNECT_SOLANA_WALLET** |               Отключение Solana кошелька от PAWS (по умолчанию - False)               |
